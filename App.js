...
import { createBottomTabNavigator } from '@react-navigation/bottom-tabs/unstable';
  ...
  return (
    <NavigationContainer>
      <Tab.Navigator initialRouteName="Home">
        ...
        <Tab.Screen name="Neighbourhood" component={NeighbourhoodPage} options={{ title: 'Neighbourhood' }} />
